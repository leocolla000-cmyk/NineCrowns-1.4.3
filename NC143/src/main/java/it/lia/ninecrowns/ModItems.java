...
public final class ModItems {
    ...
    public static void applyRequiredProperties(ItemStack stack, RegistryAccess access) {
        ...
        boolean needsUpdate =
            ...
            (stack.is(SPEAR) && (current.getLevel(lunge) != 5 || current.getLevel(sharpness) != 5)) ||
        ...
        // allows Protection X and Lunge V, which are above vanilla survival limits.
        // Sharpness V is also forced onto the OP spear as requested.
